...
# Basis statuses
HIGHS_BASIS_STATUS_BASIC = <int> HighsBasisStatusBASIC
HIGHS_BASIS_STATUS_LOWER = <int> HighsBasisStatusLOWER
HIGHS_BASIS_STATUS_UPPER = <int> HighsBasisStatusUPPER
